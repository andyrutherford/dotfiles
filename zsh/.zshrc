...
plugins=(git docker colorize zsh-autosuggestions zsh-syntax-highlighting)
...
alias sshnr="ssh 'root@198.46.217.167'"
alias cat="ccat"

# Set NVM Node version on terminal open
...
# END: Set NVM Node version on terminal open
